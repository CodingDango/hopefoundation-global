...
const programs = [
  ...
  },
  {
    ...
    description:
      "Offering job training, mentorship, and educational programs to help people build sustainable futures.",
    icon: Lightbulb,
  },
  {
      ...
      <Container>
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-pretty text-lg text-muted-foreground">
            Our programs are designed to meet immediate needs while building
            pathways to long-term stability and hope.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {programs.map((program) => {
            ...
            return (
              <Card key={program.title} className="shadow-sm border">
                <CardHeader>
